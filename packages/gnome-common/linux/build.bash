...
# --------------------------------------------------------------------------------
CreateAndChdirIntoBuildDir gnome-common

# --------------------------------------------------------------------------------
# Check out the source into the build directory:
# --------------------------------------------------------------------------------
packageSubDir=gnome-common
...
gnomeautogenFile="$INSTALL_DIR/bin/gnome-autogen.sh"
if [ ! -f "$gnomeautogenFile" ]
then
  echo "ERROR: Could not find expected file at: $gnomeautogenFile"
  exit 1
fi

echo "Note: All installation tests passed. gnome-common was built and installed."
exit 0
